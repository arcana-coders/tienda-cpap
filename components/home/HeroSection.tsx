    ...
    <section className="relative w-full bg-surface-container-lowest overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[520px]">
        ...
        <div className="z-10 flex flex-col space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20c05c] text-white px-8 py-3.5 rounded-xl font-body font-bold hover:shadow-[0_4px_18px_rgba(37,211,102,0.4)] active:scale-95 hover:-translate-y-0.5 transition-all w-full sm:w-auto text-sm"
            >
            ...
            <Link
              href="/categorias"
              className="inline-flex items-center justify-center gap-2 bg-white text-primary px-8 py-3.5 rounded-xl font-body font-semibold border border-outline-variant/30 hover:bg-surface-container-low hover:border-primary/30 active:scale-95 transition-all w-full sm:w-auto text-sm"
            >
              Ver soluciones
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-xs text-on-surface-variant pt-2">
        ...
        <div className="relative h-[400px] lg:h-[500px] rounded-2xl md:rounded-[2rem] overflow-hidden shadow-2xl shadow-primary/10">
          ...
          {/* Floating Glass Card */}
          <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8 bg-white/95 rounded-xl p-5 border border-white/40 shadow-xl flex items-center justify-between">
            ...
            <div className="hidden sm:flex w-12 h-12 rounded-full bg-primary items-center justify-center flex-shrink-0 shadow-sm shadow-primary/30">
