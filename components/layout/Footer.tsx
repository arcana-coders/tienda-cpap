      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto">
        ...
        <div className="col-span-1 md:col-span-1 flex flex-col items-start">
          ...
          <p className="text-on-surface-variant mb-6 max-w-sm leading-relaxed">
            Cuidado respiratorio preciso, repuestos e higiene, enviados de manera rápida y segura a todo México.
          </p>
          <a
            href={`https://wa.me/${WA_NUMBER}?text=${WA_MESSAGE}`}
            target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 text-on-surface hover:text-[#25D366] font-medium transition-colors mb-6"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 text-on-surface hover:text-primary font-medium transition-colors"
          >
